...
.. py:currentmodule:: Thinslave.core.config
...
.. automodule:: Thinslave.core.config
...
.. automodule:: Thinslave.core.drivers
    :members:

Base Driver
^^^^^^^^^^^
.. autoclass:: Thinslave.core.drivers.red_base.BaseDriver
    :members:

JSON Driver
^^^^^^^^^^^
.. autoclass:: Thinslave.core.drivers.red_json.JSON
    :members:

Mongo Driver
^^^^^^^^^^^^
.. autoclass:: Thinslave.core.drivers.red_mongo.Mongo
    :members:
