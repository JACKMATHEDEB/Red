...
from Thinslave.core.bot import Red, ExitCodes
from Thinslave.core.cog_manager import CogManagerUI
from Thinslave.core.json_io import JsonIO
from Thinslave.core.global_checks import init_global_checks
from Thinslave.core.events import init_events
from Thinslave.core.cli import interactive_config, confirm, parse_cli_flags
from Thinslave.core.core_commands import Core
from Thinslave.core.dev_commands import Dev
from Thinslave.core import __version__, modlog, bank, data_manager
...
def list_instances():
    if not data_manager.config_file.exists():
        print(
            ...
            "using `Thinslave-setup` before trying to run the bot!"
        )
        sys.exit(1)
    else:
...
def main():
    ...
    Thinslave.logging.init_logging(
