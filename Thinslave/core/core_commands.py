...
class CoreLogic:
    ...
    async def _version_info(cls) -> Dict[str, str]:
        ...
        -------
        dict
            `Thinslave` and `discordpy` keys containing version information for both.
        """
        return {"Thinslave": __version__, "discordpy": discord.__version__}
...
class Core(commands.Cog, CoreLogic):
    ...
    async def locale(self, ctx: commands.Context, locale_name: str):
        ...
        """
        red_dist = pkg_resources.get_distribution("Thinslave-DiscordBot")
        red_path = Path(red_dist.location) / "Thinslave"
    ...
    async def backup(self, ctx: commands.Context, *, backup_path: str = None):
        ...
        from Thinslave.core.data_manager import basic_config, instance_name
    ...
    async def datapath(self, ctx: commands.Context):
        ...
        from Thinslave.core.data_manager import basic_config
