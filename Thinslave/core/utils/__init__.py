...
async def fuzzy_command_search(
    ...
    *,
    ...
    Parameters
    ----------
    ctx : `commands.Context <Thinslave.core.commands.Context>`
    ...
    Returns
    -------
    Optional[List[`commands.Command <Thinslave.core.commands.Command>`]]
...
async def format_fuzzy_results(
    ...
    *,
    ...
    matched_commands : List[`commands.Command <Thinslave.core.commands.Command>`]
