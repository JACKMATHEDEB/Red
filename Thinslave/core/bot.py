...
log = logging.getLogger("Thinslave")
        ...
        for command in cog.__cog_commands__:
            ...
            if not isinstance(command, commands.Command):
                raise RuntimeError(
                    ...
                    "If this is your cog, please use `from Thinslave.core import commands`"
                    "in place of `from discord.ext import commands`. For more details on "
                    "this requirement, see this page: "
                    "http://Thinslave-DiscordBot.readthedocs.io/en/v3-develop/framework_commands.html"
                )
        super().add_cog(cog)
