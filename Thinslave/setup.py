...
import Thinslave.logging
from Thinslave.core.cli import confirm
from Thinslave.core.data_manager import (
...
from Thinslave.core.json_io import JsonIO
from Thinslave.core.utils import safe_delete
from Thinslave.core import Config
from Thinslave.core.drivers import BackendType, IdentifierData
from Thinslave.core.drivers.red_json import JSON

conversion_log = logging.getLogger("red.converter")

config_dir = None
appdir = appdirs.AppDirs("Thinslave-DiscordBot")
...
def basic_setup():
    ...
    if storage_type == BackendType.MONGO:
        from Thinslave.core.drivers.red_mongo import get_config_details
    ...
    print()
    print(
        "Your basic configuration has been saved. Please run `Thinslave <name>` to"
...
async def json_to_mongov2(instance):
    ...
    from Thinslave.core.drivers import red_mongo
...
async def mongov2_to_json(instance):
    ...
    from Thinslave.core.drivers import red_json
...
async def mongo_to_json(instance):
    ...
    from Thinslave.core.drivers.red_mongo import Mongo
...
async def create_backup(instance):
    ...
    if confirm("Would you like to make a backup of the data for this instance? (y/n)"):
        ...
        if pth.exists():
            ...
            from Thinslave.cogs.downloader.repo_manager import RepoManager
...
def cli(ctx, debug):
    ...
    Thinslave.logging.init_logging(level=level, location=Path.cwd() / "red_setup_logs")
