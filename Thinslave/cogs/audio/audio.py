...
import Thinslave.core
from Thinslave.core import Config, commands, checks, bank
from Thinslave.core.data_manager import cog_data_path
from Thinslave.core.i18n import Translator, cog_i18n
from Thinslave.core.utils.chat_formatting import bold, box, pagify
from Thinslave.core.utils.menus import (
    menu,
    DEFAULT_CONTROLS,
    prev_page,
    next_page,
...
class Audio(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        default_global = dict(
            ...
            restrict=True,
            current_version=Thinslave.core.VersionInfo.from_str("3.0.0a0").to_json(),
    ...
    async def settings(self, ctx):
        ...
        dc = data["disconnect"]
        jarbuild = Thinslave.core.__version__
