...
import discord
from Thinslave.core import checks, commands, Config, version_info as red_version_info
from Thinslave.core.bot import Red
from Thinslave.core.data_manager import cog_data_path
from Thinslave.core.i18n import Translator, cog_i18n
from Thinslave.core.utils.chat_formatting import box, pagify, humanize_list, inline
from Thinslave.core.utils.menus import start_adding_reactions
from Thinslave.core.utils.predicates import MessagePredicate, ReactionPredicate
...
class Downloader(commands.Cog):
    ...
    def format_findcog_info(
        ...
        if isinstance(cog_installable, Installable):
            ...
            made_by = "26 & co."
            repo_url = "https://github.com/Thinmatrix/Thinslave-DiscordBot"
