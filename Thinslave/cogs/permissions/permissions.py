...
from Thinslave.core import checks, commands, config
from Thinslave.core.bot import Red
from Thinslave.core.i18n import Translator, cog_i18n
from Thinslave.core.utils.chat_formatting import box
from Thinslave.core.utils.menus import start_adding_reactions
from Thinslave.core.utils.predicates import ReactionPredicate, MessagePredicate
...
class Permissions(commands.Cog):
    ...
    async def permissions_explain(self, ctx: commands.Context):
        ...
        message = _(
            ...
            "(https://Thinslave-DiscordBot.readthedocs.io/en/v3-develop/cog_permissions.html)."
        )
