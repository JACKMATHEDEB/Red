...
from Thinslave.cogs.warnings.helpers import (
    warning_points_add_check,
    get_command_for_exceeded_points,
    get_command_for_dropping_points,
    warning_points_remove_check,
)
from Thinslave.core import Config, checks, commands, modlog
from Thinslave.core.bot import Red
from Thinslave.core.i18n import Translator, cog_i18n
from Thinslave.core.utils.mod import is_admin_or_superior
from Thinslave.core.utils.chat_formatting import warning, pagify
from Thinslave.core.utils.menus import menu, DEFAULT_CONTROLS
